                ...
                switch (op) {
                    ...
                    case '$set':
                        Object.keys(_value).forEach(field => {
                            obj = OperationSet.applyOperationAt(module.exports.$set, obj, field, [_value[field]])
                        })
                        break
                    case '$unset':
                        ...
                        _value.forEach(field => {
                            obj = OperationSet.applyOperationAt(module.exports.$unset, obj, field)
                        })
                        break
                    case '$move':
                        Object.keys(_value).forEach(field => {
                            obj = OperationSet.applyOperationAt(module.exports.$move, obj, field, [_value[field].split('.')])
                        })
                        break
                    case '$copy':
                        Object.keys(_value).forEach(field => {
                            obj = OperationSet.applyOperationAt(module.exports.$copy, obj, field, [_value[field].split('.')])
                        })
                        break
                    case '$wrap':
                        ...
                        Object.keys(_value).forEach(field => {
                            obj = OperationSet.applyOperationAt(module.exports.$wrap, obj, field, [_value[field]])
                        })
                        break
                    case '$cast':
                        Object.keys(_value).forEach(field => {
                    ...
                    case '$map':
                        Object.keys(_value).forEach(field => {
                            obj = module.exports.$map(obj, field, [_value[field]])
                        })
                        break
                    case '$models':
                        ...
                        Object.keys(_value).forEach(_path => {
                            ...
                            _procs.forEach(_proc => {
                                if (!this.models[_proc]) {
                                    throw new InvalidOperationError('No such model: ' + _proc)
                                } else {
                                    obj = OperationSet.applySet(this.models[_proc], obj, _path)
                                }
                            })
                        })
                        break
