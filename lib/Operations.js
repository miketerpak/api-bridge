...
class OperationSet {
    ...
    process(obj) {
        for (let opSet of this.__operations) {
            // TODO write module.exports.$func
            // TOGO write module.exports.$models
            if (opSet.operation === '$models') {
                ...
                obj = this.applyOperationAt(module.exports[opSet.operation], obj, opSet.field, opSet.args)
            }
        }
                ...
                switch (key) {
                    ...
                    case '$wrap':
                        if (typeof ops[key] === 'string' || Array.isArray(ops[key])) {
                            ...
                            Object.keys(ops[key]).forEach(field => {
                                if (typeof ops[key][field] !== 'string' && !Array.isArray(ops[key][field])) {
                                    throw new InvalidOperationError('Invalid value for $wrap. Expected string or array, got ' + typeof ops[key][field])
                                }
                                this.__operations.push({
                                    operation: key,
                                    field: OperationSet.parsePath(field),
                    ...
                    case '$func':
                        if (typeof ops[key] === 'function') {
                            ...
                            Object.keys(ops[key]).forEach(field => {
                                if (typeof ops[key][field] !== 'function') {
                                    throw new InvalidOperationError('Invalid value for $func. Expected function, got ' + typeof ops[key][field] + ' at key ' + field)
                                }
                                this.__operations.push({
                                    operation: key,
                                    field: OperationSet.parsePath(field),
